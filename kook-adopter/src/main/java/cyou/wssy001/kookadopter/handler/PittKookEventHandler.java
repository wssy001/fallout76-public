    ...
    public BaseReplyMsgDTO consume(BaseEvent baseEvent, BasePlatformEventDTO basePlatformEventDTO) {
        if (basePlatformEventDTO instanceof KookEventDTO kookEventDTO) {
            ...
            if (CollUtil.isEmpty(pittPicUrls)) {
                ...
                format = String.format(KookReplyMsgTemplateEnum.ERROR_MSG_CARD.getMsg(), "匹兹堡奖励清单图片获取失败，请联系管理员");
            } else {
                format = String.format(KookReplyMsgTemplateEnum.PITT_CARD.getMsg(), pittPicUrls.get("1"));
            }
